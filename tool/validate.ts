...
// TODO: Validate that the extracted files are valid.
//
// "Can't resolve reference ../../node_modules/@matanlurey/tts-save-format/src/schema/SaveState.json".
//
// runTool(
//   'ajv',
//   '-d "./samples/sources/*/*.json"',
//   '-s "./src/schema/VarnishSaveState.json"',
//   '-r "./src/schema/*.json"',
//   '-r "./node_modules/@matanlurey/tts-save-format/src/schema/*.json"',
// );
